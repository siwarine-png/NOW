...
router.patch('/:id', async (req, res) => {
  const allowed = ['timezone', 'wake_time', 'sleep_time', 'quiet_start', 'quiet_end', 'checkin_time', 'push_token', 'web_push_subscription', 'identity_priorities', 'busy_until', 'desired_hours_overrides'];
  const updates = {};
